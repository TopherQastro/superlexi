...
insertedLetters = str('aaaaa')
print('insertedLetters:', insertedLetters)
while insertedLetters != 'naaaa':  # try up to 5 letters
...
superlexiFile = csv.writer(open('/home/tqastro/projects/skrypts/GitLib/superlexi/superlexiDic.csv', 'a'))
